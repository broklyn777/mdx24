    ...
    <main className="container flex pt-10 min-h-screen flex-col bg-background ">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pb-4">
          {blogs.map((blog) => (
            <Link href={"/" + blog.slug} passHref key={blog.slug}>
              {/* <Card className="hover:outline hover:outline-purple-100 hover:shadow bg-purple-50 dark:bg-gradient-to-l dark:from-purple-400 dark:to-purple-600 shadow dark:shadow-purple-800 h-64 flex flex-col justify-between"> */}
              <Card className="hover:outline hover:outline-green-700 hover:shadow bg-gray-200 dark:bg-green-800 shadow dark:shadow-green-900 h-64 flex flex-col justify-between">
                <CardHeader className="p-4 pb-2">
                  <CardTitle>{blog.meta.title}</CardTitle>
                  <CardDescription>{blog.meta.date}</CardDescription>
                </CardHeader>
